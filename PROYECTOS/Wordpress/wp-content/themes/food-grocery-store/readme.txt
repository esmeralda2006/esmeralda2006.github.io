...
= 0.5.2 =
* Added wocommerce sale border radius option in customizer.
* Updated language folder.
...
* Done css of woocommerce pagination.
...
= 0.6.1 =
* Added go pro button in trending products and footer section in customizer.
...
* Added 404 and social icon in other setting.
...
* Added css for product sale button.
...
* Resolved error for view cart button.
* Resolved error for block pattern.

= 0.8.7 =
* Resolved topbar gtranslate css error.
* Resolved cart icon count css error in tablet media.
* Added slider button text and link option in customizer.
* Added target blank in social icon. 
...
= 0.8.9 =
* Added daily deals, help desk, contact , order tracking, my account, shopping basket , wishlist icon setting option in customizer.
* Update pot file.
...
== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-food-grocery-store/