...
<div class="col-lg-6 col-md-6 col-sm-6">
	<article id="post-<?php the_ID(); ?>" <?php post_class('article-box'); ?>>
        ...
        <div class="post-summary m-0">
            ...
            <p><?php echo wp_trim_words( get_the_content(), esc_attr(get_theme_mod('grocery_supermarket_post_page_excerpt_length', 30)) ); ?><?php echo esc_html(get_theme_mod('grocery_supermarket_post_page_excerpt_suffix','[...]')); ?></p>
